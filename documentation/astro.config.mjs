			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Core Primitives', slug: 'api/primitives' },
						{ label: 'Combinators', slug: 'api/combinators' },
						{ label: 'Repetition', slug: 'api/repetition' },
						{ label: 'Convenience', slug: 'api/convenience' },
						{ label: 'Zero-Copy API', slug: 'api/zero-copy' },
					],
				},
			{
				label: 'Guides',
				items: [
					...
					{ label: 'Streaming Input', slug: 'guides/streaming' },
					{ label: 'Optimization Tips', slug: 'guides/optimization' },
				],
			},
			],
		}),
